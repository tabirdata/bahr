...
soal_ujicoba <- readRDS("soal_ujicoba.rds")
jenis_soal_ujicoba <- readRDS("jenis_soal_ujicoba.rds")
pilihan_ganda_ujicoba <- readRDS("pilihan_ganda_ujicoba.rds")
...
fbuat_data <- function(NIM) {
  ...
  populasi_data <- list(iris, iris, iris, iris)
