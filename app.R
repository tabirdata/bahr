  ...
  observeEvent(input$tombol_mulai,
               {
                 ...
                 jawaban_tersimpan <<- if (file.exists(
                   ...
                   daftar_jawaban <- vector("list", length(soal_ujicoba))
                   names(daftar_jawaban) <- paste0("jawab_", 1:length(soal_ujicoba))
                 ...
                 output$soal_soal <- renderUI({
                   ...
                   nav_panel(
                     ...
                     fsoal(
                       kolom_soal = soal_ujicoba, jenis_soal = jenis_soal_ujicoba,
                       isi_jawab = jawaban_tersimpan(),
                       pilihan_ganda = pilihan_ganda_ujicoba
                     )
                   )
                 })
               },
